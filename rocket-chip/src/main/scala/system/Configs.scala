...
//Nexys4DDR
//class DefaultConfig extends Config(new WithJtagDTMSystem ++ new WithNBigCores(1) ++ new BaseConfig ++ new WithRoccExample ++ new WithCoherentBusTopology)
class DefaultConfig extends Config(new WithJtagDTMSystem ++ new WithNBigCores(1) ++ new BaseConfig ++ new WithPac ++ new WithCoherentBusTopology)
...
class DefaultNexys4DDRConfig  extends Config(new WithJtagDTMSystem ++ new WithNBigCores(1) ++ new BaseConfig ++ new WithRoccExample)
class DefaultNexysVideoConfig extends Config(new WithExtMemSize(0x20000000) ++ new DefaultNexys4DDRConfig)
